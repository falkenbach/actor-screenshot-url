...
Apify.main(async () => {
    ...
    */ // <- for new SDK
    ...
    const proxyUrl = Apify.getApifyProxyUrl({ groups: proxyConfig.apifyProxyGroups, countryCode: input.countryCode }); // , country: input.countryCode, apifyCountryCode: input.countryCode
